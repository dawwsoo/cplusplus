...
int main() {
	...
	while (menu_num != 3)
	{
		...
		{
			system("cls");
			cout << endl << endl << endl << endl << endl << left << setw(100) << "MANUAL" << endl << endl;
			cout << setw(90) << "1.사용자는 100초의 시간을 얻습니다." << endl;
			cout << setw(90) << "2.행맨의 목숨은 9번 틀릴 경우 소멸됩니다." << endl;
			cout << setw(90) << "3.단어를 맞춘 사용자만이 랭킹에 이름을 남길 수 있습니다." << endl;
			cout << setw(90) << "4.30분 이상의 연속된 게임 활동을 지양해주십시오." << endl;
