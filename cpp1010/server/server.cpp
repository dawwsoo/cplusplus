...
//window 소켓 프로그램에 나와있음 _ 그런가보다 하면 됨 자동으로 깔려있어서 바로 사용할 수 있다.

#include <WinSock2.h> // 자동으로 깔려있어서 바로 사용할 수 있다.
#include <string>
#include <iostream>
#include <thread>
#include <vector>
...
#define MAX_CLIENT 3 //인원이 더 필요하면 늘리면 됨
...
int main() {
    ...
    if (!code) {
        ...
        std::thread th1[MAX_CLIENT]; //선언만 하고 초기화를 밑에서 한거
